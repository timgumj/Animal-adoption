...
if ($type) {
  ...
  if ($result && mysqli_num_rows($result) == 0) {
          ...
          <div class='row g-0 h-100'>
            ...
            <div class='col-md-8'>
              <div class='card-body'>
                ...
                <p class='card-text'><a href='publisher.php?publisher_name={$value["publisher_name"]}' class='publisher-link'>Publisher: {$value["publisher_name"]}</a></p>
                <p class='card-text'>Publisher addr: {$value["publisher_address"]}</p>
                <p class='card-text'>Publish date: {$value["publish_date"]}</p>
                <a href='details.php?id={$value["id"]}' class='btn btn-dark'>Details</a>
              </div>
            </div>
          </div>
        </div>
    ...
    $layout .= "<p>Error executing query</p>";
  }
} else {
  $layout .= "<p>No type specified</p>";
}
?>
...
<body>
  ...
  <div class="container overflow-hidden">
    <div class="row p-4 row-cols-1 row-cols-md-2 g-4">
      <?= $layout ?>
    </div>
  </div>
  <br>
  ...
  <footer>
    ...
    <div class="footerBottom">
      <p>Copyright &copy; 2024; BigLibrary <span class="designer">Julius</span></p>
    </div>
  </footer>
